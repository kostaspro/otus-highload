...
namespace Otus.Highload.EFCore.Migrations
{
    ...
    [Migration("20250329093149_add_users_is_celebrity")]
    partial class add_users_is_celebrity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Otus.Highload.Dialogs.DialogEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id", "ToUserId")
                        .HasName("pk_dialogs");

                    b.HasIndex("UserId", "ToUserId")
                        .HasDatabaseName("ix_dialogs_user_id_to_user_id");

                    b.ToTable("dialogs", (string)null);
                });

            modelBuilder.Entity("Otus.Highload.Posts.PostEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Otus.Highload.Users.UserEntity", b =>
                {
                    ...
                    b.Property<bool?>("IsCelebrity")
                        .HasColumnType("boolean")
                        .HasColumnName("is_celebrity");
            ...
            modelBuilder.Entity("Otus.Highload.Posts.PostEntity", b =>
                {
                    b.HasOne("Otus.Highload.Users.UserEntity", null)
                        .WithMany()
